  ...
  const loadRoutes = async () => {
    try {
      ...
      const formattedRoutes: Route[] = routesData.map((route: any) => ({
        ...
        to: route.to_city,
        price: "200,000", // Giá mặc định, có thể lấy từ trips
        duration: `${route.estimated_duration_min} phút`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            ...
            <div className="col-span-full text-center py-8">
              <div className="text-gray-500">Không tìm thấy tuyến đường nào</div>
            </div>
          ) : (
